...
from Boosted_SFW_KL_3D import*
import scipy
import matplotlib.pyplot as plt

def Homotopy_Boosted_SFW_KULLBACK_3D(acquis, bg, sigma_target, sig_x, sig_y, sig_z, X_domain, Y_domain, Z_domain, N_xy, N_z, 
                                      pixel_size_xy, pixel_size_z, 
        m_0=0, lambda_0 = None, nnIter=5, nIter=1, c=5, BoostPar = float('inf'), verbose = False, plots = False, gt = 0):
    ...
    for k in range(nnIter): 
        ...
        (measure_k, nrj) = Boosted_SFW_KULLBACK_3D(acquis, bg, sig_x, sig_y, sig_z, X_domain ,Y_domain , Z_domain,  N_xy, N_z, 
