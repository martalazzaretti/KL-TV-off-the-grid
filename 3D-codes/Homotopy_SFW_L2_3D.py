...
from SFW_L2_3D import*
import scipy
import matplotlib.pyplot as plt

def Homotopy_SFW_L2_3D(acquis, bg, sigma_target, sig_x, sig_y, sig_z, X_domain, Y_domain, Z_domain, N_xy, N_z, 
    ...
    for k in range(nnIter): 
        ...
        (measure_k, nrj) = SFW_L2_3D(acquis, bg, sig_x, sig_y, sig_z, X_domain ,Y_domain , Z_domain,  N_xy, N_z, 
